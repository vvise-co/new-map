-- V2: Recreate tables with UUID primary keys
-- This migration handles the transition from old bigint-based schema to UUID

-- Drop existing tables (cascade to remove foreign key constraints)
